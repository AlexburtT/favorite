...
export default function normalizeMovieData(rawMovie) {
    return {
        ...
        releaseYear: typeof rawMovie.releaseYear === 'number' ? rawMovie.releaseYear : null,
        poster: Array.isArray(rawMovie.poster) && rawMovie.poster.length > 0
            ? rawMovie.poster
            : ['http://localhost:3000/posters/no_product_img.png'],
        genres: Array.isArray(rawMovie.genres) && rawMovie.genres.length > 0
            ? rawMovie.genres
            : ['Жанр не указан'],
